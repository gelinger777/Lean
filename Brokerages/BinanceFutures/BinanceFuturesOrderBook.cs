...
namespace QuantConnect.Brokerages.BinanceFutures
{
    ...
    /// </summary>
    public class BinanceFuturesOrderBook: DefaultOrderBook
    {
        /// <summary>
        /// Last update event
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BinanceFuturesOrderBook"/> class
        /// </summary>
        /// <param name="symbol">The symbol for the order book</param>
        public BinanceFuturesOrderBook(Symbol symbol): base(symbol) { }
