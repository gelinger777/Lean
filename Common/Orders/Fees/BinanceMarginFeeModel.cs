...
{
    /// <summary>
    /// Provides an implementation of <see cref="FeeModel"/> that models BinanceMargin order fees
    /// </summary>
    public class BinanceMarginFeeModel : FeeModel
    {
        /// <summary>
        /// Tier 1 maker fees
        /// https://www.BinanceMargin.com/en/fee/schedule
        /// </summary>
        ...
        /// <summary>
        /// Creates BinanceMargin fee model setting fees values
        /// </summary>
        /// <param name="mFee">Maker fee value</param>
        /// <param name="tFee">Taker fee value</param>
        public BinanceMarginFeeModel(decimal mFee = MakerTear1Fee, decimal tFee = TakerTear1Fee)
        {
            makerFee = mFee;
            takerFee = tFee;
        }
        ...
        public override OrderFee GetOrderFee(OrderFeeParameters parameters)
        {
            ...
            var props = order.Properties as BinanceMarginOrderProperties;
