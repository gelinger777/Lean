...
namespace QuantConnect.Orders
{
    ...
    /// </summary>
    public class BinanceFuturesOrderProperties : OrderProperties
    {
        /// <summary>
        ...
        public BinanceTimeInForce TIF { get; set; } = BinanceTimeInForce.GTC;
        ...
        {
            return (BinanceFuturesOrderProperties)MemberwiseClone();
        }
    }
