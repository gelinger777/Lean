...
{
    /// <summary>
    /// Contains additional properties and settings for an order submitted to BinanceMargin brokerage
    /// </summary>
    public class BinanceMarginOrderProperties : OrderProperties
    {
        /// <summary>
        ...
        {
            return (BinanceMarginOrderProperties)MemberwiseClone();
        }
    }
}
