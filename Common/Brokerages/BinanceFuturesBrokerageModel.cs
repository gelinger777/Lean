...
namespace QuantConnect.Brokerages
{
    ...
    /// </summary>
    public class BinanceFuturesBrokerageModel : DefaultBrokerageModel
    {
        /// <summary>
        ...
        public BinanceFuturesBrokerageModel(AccountType accountType = AccountType.Margin) : base(accountType)
        {
        }
        ...
        public override decimal GetLeverage(Security security)
        {
            ...
            if (security.Type == SecurityType.Crypto || security.Type == SecurityType.Equity)
            {
        ...
        private static IReadOnlyDictionary<SecurityType, string> GetDefaultMarkets()
        {
            ...
            map[SecurityType.Equity] = Market.BinanceFutures;
